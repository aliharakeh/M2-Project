...
class TwitterScrapper:
    def __init__(self, chrome_manager=None):
        # instance variables
        self._cm: ChromeManager = chrome_manager if chrome_manager else ChromeManager()
    ...
    def get_user_details(self, username):
        ...
        return {
            'username': self._cm.get_value(TWITTER_USER['username']),
            'display-name': self._cm.get_value(TWITTER_USER['display-name']),
            'description': self._cm.get_value(TWITTER_USER['description']),
            'joined': self._cm.get_value(TWITTER_USER['joined']),
            'following': self._cm.get_value(TWITTER_USER['following']),
            'followers': self._cm.get_value(TWITTER_USER['followers']),
            'place': self._cm.get_value(TWITTER_USER['place'])
        }
